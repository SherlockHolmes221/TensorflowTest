...
本竞品分析主要通过对**腾讯WiFi管家**和**WiFi万能钥匙**的比较，分析两款产品在**响应、搜索WiFi能力、内存分析、GPU渲染、耗电量、市场竞争力、功能分析、用户交互分析**等7个方面的优劣势，从而得出目前两款产品的目前现状和发展前景。
...
## 耗电分析
用PowerTutor对两款应用作耗电量分析，场景为打开应用之后熄屏一小时，比较两个应用在熄屏状态下的耗电量。
产品|腾讯WiFi管家|WiFi万能钥匙
:---:|:--:|:---:
灭屏后台一小时耗电|J|J
